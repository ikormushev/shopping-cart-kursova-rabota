...
//        priceMapper.deletePricesByStoreId(FANTASTIKO_STORE_ID.toString());
...
//        ProductEntity product = productMapper.searchProductsByName(cleanName);
//
//        if (product == null) {
...
//            priceEntity.setStoreId(FANTASTIKO_STORE_ID.toString()); // Фантастико ID
